...
(function($) {
  ...
  var bgVideo = function() {
	...
	function makeTimer() {
		...
		var endTime = new Date("02 January 2020 11:00:00 GMT+01:00");			
...
var   ticketdownload = function() 
{
	$("input#ticket").on('click',  function (event) {
		...
		"ERIC","EYOUMCASSIDY","FINDJEORNEL","FOFIE","FOTSINGFLORIANT","FOTSINGJENNY","FOTSOJEANERNEST","FOUDJOJOVIAL",
		...
		"KENMOGNESYNTHIA","KOUNGAVICKY","KOUONANGMONIQUE","KUAGUIMDUPONT","KUATEJOEL","LEMOVICTORINE","MAGNYHILARY","MARIAMOUNINA",
		"MATANDALEA","MAYOPACEDRIC","MBAKOPELISABETH","MBIAKOP","MBOUEFABRICE","MEKAMMOSELLE","MEKOUNTCHOUNANCY","MEKOUNTCHOUWESLEY",
		"MERLIN","MOKTOMOPAMELA","MOLUHAICHA","MOUDIEMMANUEL","MOUGNUTOUSAMIRA","MOUNCHIKPOUARMELLE","NAKEUPAULIN","NDJINKEFIERTE",
		"NDOUMBASERENA","NDOUMGAZACHARIE","NDZUIGUIAERIC","NDZUIGUIAFRANCK","NGAGOUEAURELIE","NGNETHEOPHANE","NGOMNEBORIS","NGOMPEVANESSA",
		"NGOTAP","NGUEDICYRIL","NGUENANGCHRISTELLE","NGUIMFACKDORIANE","NKOMOLADOUCE","NOUBISSICAMILLE","NOUNEAGUELIDRINE",
		...
		"TCHAMBAPENIEL","TCHAPMIDONALD","TCHATATSTEVE","TCHIENTCHEUCARMELA","TCHOKOIVAN","TCHOMBOUSIDOINE","TCHOUNDJIAJOREL","TCHOUPEYANNICK",
		"TENERACHELLE","TOUPENDIABDOUL","TSAGUELAETICIA","VAREL","YAMBAVIVIANE","YANOULEO","FAHKELLY"];
		if(name != "" && pass != "")	
		{
