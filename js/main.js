...
var   ticketdownload = function() 
{
	$("input#ticket").on('click',  function (event) {
		...
		"NDJABAJEANFLAUBERT","NDJABALESLYNE","NDOUMBAIVAN","NGATCHATEUTCHOU","NGONDJEPHERVE","NGONOELODIE","NGONOLUDOVIC",
		...
		"ERIC","EYOUMCASSIDY","TCHATCHOUORNEL","FOFIE","FOTSINGFLORIANT","FOTSINGJENNY","FOTSOJEANERNEST","FOUDJOJOVIAL",
